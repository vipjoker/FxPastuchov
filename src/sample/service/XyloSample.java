 ...
 */
public class XyloSample  extends Application {
        ...
        private void init(Stage primaryStage) {
            ...
            Scene scene = new Scene(root, 1000,1000,true, SceneAntialiasing.DISABLED);
            primaryStage.setScene(scene);

            PerspectiveCamera perspectiveCamera = new PerspectiveCamera();
            primaryStage.getScene().setCamera(perspectiveCamera);
            ...
            root.getTransforms().addAll(
                    new Translate(500,500),
                    new Rotate(180, Rotate.X_AXIS)
            );
            root.getChildren().add(create3dContent());

            root.getChildren().add(new Sphere(100,8));
            scene.setOnMouseMoved(event -> {
                System.out.println(event.getSceneX());

                rotateY.setAngle(event.getSceneX()%360);
                rotateX.setAngle(event.getSceneY()%360);
...
//                    new AudioClip(XyloSample.class.getResource("Note1.wav").toString());
//            final AudioClip bar2Note =
//                    new AudioClip(XyloSample.class.getResource("Note2.wav").toString());
//            final AudioClip bar3Note =
//                    new AudioClip(XyloSample.class.getResource("Note3.wav").toString());
//            final AudioClip bar4Note =
//                    new AudioClip(XyloSample.class.getResource("Note4.wav").toString());
//            final AudioClip bar5Note =
//                    new AudioClip(XyloSample.class.getResource("Note5.wav").toString());
//            final AudioClip bar6Note =
//                    new AudioClip(XyloSample.class.getResource("Note6.wav").toString());
//            final AudioClip bar7Note =
//                    new AudioClip(XyloSample.class.getResource("Note7.wav").toString());
//            final AudioClip bar8Note =
//                    new AudioClip(XyloSample.class.getResource("Note8.wav").toString());
            ...
            bar2Cube.setOnMousePressed(new EventHandler<MouseEvent>() {
                public void handle(MouseEvent me) { System.out.println("play2"); }
            });
            bar3Cube.setOnMousePressed(new EventHandler<MouseEvent>() {
                public void handle(MouseEvent me) { System.out.println("play3"); }
            });
            bar4Cube.setOnMousePressed(new EventHandler<MouseEvent>() {
                public void handle(MouseEvent me) { System.out.println("play4"); }
            });
            bar5Cube.setOnMousePressed(new EventHandler<MouseEvent>() {
                public void handle(MouseEvent me) { System.out.println("play5"); }
            });
            bar6Cube.setOnMousePressed(new EventHandler<MouseEvent>() {
                public void handle(MouseEvent me) { System.out.println("play6"); }
            });
            bar7Cube.setOnMousePressed(new EventHandler<MouseEvent>() {
                public void handle(MouseEvent me) {System.out.println("play7");; }
            });
            bar8Cube.setOnMousePressed(new EventHandler<MouseEvent>() {
                public void handle(MouseEvent me) { System.out.println("play8"); }
            });
